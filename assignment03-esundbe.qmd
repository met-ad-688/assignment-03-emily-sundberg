...
fig.update_layout(
  title=dict(
    ...
    font=dict(size=30, family="Garamond", color = "saddlebrown", weight="bold")
  )

  xaxis=dict(
    title=dict(text="NAICS2 Name", font=dict(size=14, family="garamond", color="saddlebrown", weight="bold")),
    tickangle=45,
    showline=True,
    linewidth=2,
  ...
  yaxis=dict(
    title=dict(text="Salary (K $)", font=dict(size=14, family="garamond", color="saddlebrown", weight="bold")),
    ...
    tickfont=dict(size=12, family="garamond", color="saddlebrown",weight="bold"),
    showline=True,
    linewidth=2,
    linecolor="saddlebrown",
    mirror=True,
